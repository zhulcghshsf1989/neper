...
void
P2PmVerFace (struct POLY Poly, struct POLYMOD *pPolymod)
{
  int i, j;
...
void
P2PmVerCoo (struct POLY Poly, struct POLYMOD *pPolymod)
{
  int i, j;
...
void
P2PmVerUse (struct POLYMOD *pPolymod)
{
  int i;
...
void
P2PmFacePoly (struct POLY Poly, struct POLYMOD *pPolymod)
{
  int i;
...
void
P2PmFaceEq (struct POLY Poly, struct POLYMOD *pPolymod)
{
  int i, j;
...
void
P2PmFaceVerQty (struct POLY Poly, struct POLYMOD *pPolymod)
{
  int i;
...
void
P2PmFaceVerNb (struct POLY Poly, struct POLYMOD *pPolymod)
{
  int i, j;
  ...
  for (i = 1; i <= (*pPolymod).FaceQty; i++)
  {
    (*pPolymod).FaceVerNb[i] = ut_alloc_1d_int ((*pPolymod).FaceVerQty[i] + 1);
...
void
P2PmFaceUse (struct POLYMOD *pPolymod)
{
  int i;
