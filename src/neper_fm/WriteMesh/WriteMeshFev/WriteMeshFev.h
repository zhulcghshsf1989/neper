...
extern void neut_mesh_fprintf_fev_elts (FILE *, struct GEO, struct NSET, struct MESH);
extern void neut_mesh_fprintf_fev_skinelts (FILE*, struct GEO, struct MESH, struct MESH, struct NODES, struct NSET, char*);
