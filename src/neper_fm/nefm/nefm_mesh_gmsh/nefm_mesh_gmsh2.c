...
void
nefm_mesh_gmsh_options (FILE * file, int algo2d, int algo3d, int opti,
			double rnd)
{
...
void
nefm_mesh_2d_gmsh_writenodes (struct GEO Geo, struct NODES Nodes,
...
void
nefm_mesh_2d_gmsh_write1dmesh (struct GEO Geo, struct MESH Mesh1D, int face,
			       FILE * file)
{
  int i, j, elt, edge;
