...
void
ut_mat_transpose (int n, double **A, double **T)
{
  int i, j;
  double **Cpy = ut_alloc_2d (n, n);

  ut_array_2d_memcpy (Cpy, n, n, A);
...
void
ut_mat_transpose_ns (int n1, int n2, double **A, double **T)
{
  int i, j;
  double** Cpy = ut_alloc_2d (n1, n2);

  ut_array_2d_memcpy (Cpy, n1, n2, A);
