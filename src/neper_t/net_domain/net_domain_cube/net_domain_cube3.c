...
IniVerCoo (double *size, struct POLY *pDomain)
{
  ...
  (*pDomain).VerCoo[1][0] = size[1];
  (*pDomain).VerCoo[1][1] = size[3];
  (*pDomain).VerCoo[1][2] = size[5];

  (*pDomain).VerCoo[2][0] = size[2];
  (*pDomain).VerCoo[2][1] = size[3];
  (*pDomain).VerCoo[2][2] = size[5];

  (*pDomain).VerCoo[3][0] = size[2];
  (*pDomain).VerCoo[3][1] = size[4];
  (*pDomain).VerCoo[3][2] = size[5];

  (*pDomain).VerCoo[4][0] = size[1];
  (*pDomain).VerCoo[4][1] = size[4];
  (*pDomain).VerCoo[4][2] = size[5];

  (*pDomain).VerCoo[5][0] = size[1];
  (*pDomain).VerCoo[5][1] = size[3];
  (*pDomain).VerCoo[5][2] = size[6];

  (*pDomain).VerCoo[6][0] = size[1];
  (*pDomain).VerCoo[6][1] = size[4];
  (*pDomain).VerCoo[6][2] = size[6];

  (*pDomain).VerCoo[7][0] = size[2];
  (*pDomain).VerCoo[7][1] = size[4];
  (*pDomain).VerCoo[7][2] = size[6];

  (*pDomain).VerCoo[8][0] = size[2];
  (*pDomain).VerCoo[8][1] = size[3];
  (*pDomain).VerCoo[8][2] = size[6];
