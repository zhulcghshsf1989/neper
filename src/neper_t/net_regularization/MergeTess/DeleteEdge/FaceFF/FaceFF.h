...
extern double FaceFFMesh (struct TESS *, struct REG, struct IN, int);
extern void FaceFFMeshTess (struct TESS *, struct REG, int *);
...
/*
extern double ThisVerFaceFF2 (struct TESS *, struct REG, struct IN, int,
			      int);
*/
