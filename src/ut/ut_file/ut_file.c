...
{
  int res;
  char* format2 = ut_alloc_1d_char (20);
...
int
ut_file_format (char* filename, char* format)
{
  int res;
  ...
  if (strcmp (string, "***tess1.4") == 0)
  {
    sprintf (format, "tesl");
    res = 1;
  }
  if (strcmp (string, "***geo1.9") == 0)
  {
    sprintf (format, "tess");
    res = 1;
  }
  if (strcmp (string, "***tess1.9") == 0)
  {
    sprintf (format, "tess");
    res = 1;
  }
  ...
  {
    sprintf (format, "gmsh_msh");
    res = 1;
  }
  if (strcmp (string, "***geometry") == 0)
  {
    sprintf (format, "zebulon_geof");
    res = 1;
  }
