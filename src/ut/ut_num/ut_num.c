...
double
ut_num_max3 (double n1, double n2, double n3)
{
  if (n1 > n2)
    n2 = n1;
...
double
ut_num_absmax3 (double n1, double n2, double n3)
{
  if (n1 < 0)
    n1 *= -1;
  if (n2 < 0)
...
int
ut_num_absmax3_index (double n1, double n2, double n3)
{
  int id;
...
void
ut_num_scale (double *num, double scale)
{
  (*num) *= scale;
...
/* returns 1 if a>=b, 0 else. */
int
ut_num_higher (double a, double b)
{
  if (a >= b)
    return 1;
  else
...
/* returns 1 if a<=b, 0 else. */
int
ut_num_lower (double a, double b)
{
  if (a <= b)
    return 1;
  else
...
/* returns 1 if |a|>=|b|, 0 else. */
int
ut_num_ahigher (double a, double b)
{
  if (fabs (a) >= fabs (b))
    return 1;
  else
...
/* returns 1 if |a|<=|b|, 0 else. */
int
ut_num_alower (double a, double b)
{
  if (fabs (a) <= fabs (b))
    return 1;
  else
