...
neut_tess_compress_faces (struct TESS* pTess)
{
  ...
  // realloc'ing
  (*pTess).FacePoly = ut_realloc_2d_int_delline ((*pTess).FacePoly, (*pTess).FaceQty + 1, pos + 1);
  (*pTess).FaceEq = ut_realloc_2d_delline ((*pTess).FaceEq, (*pTess).FaceQty + 1, pos + 1);
  (*pTess).FaceVerQty = ut_realloc_1d_int ((*pTess).FaceVerQty, pos + 1);
  (*pTess).FaceVerNb = ut_realloc_2d_int_delline ((*pTess).FaceVerNb, (*pTess).FaceQty + 1, pos + 1);
  (*pTess).FaceEdgeNb = ut_realloc_2d_int_delline ((*pTess).FaceEdgeNb, (*pTess).FaceQty + 1, pos + 1);
  (*pTess).FaceEdgeOri = ut_realloc_2d_int_delline ((*pTess).FaceEdgeOri, (*pTess).FaceQty + 1, pos + 1);
  (*pTess).FaceState = ut_realloc_1d_int ((*pTess).FaceState, pos + 1);
  (*pTess).FacePt = ut_realloc_1d_int ((*pTess).FacePt, pos + 1);
  (*pTess).FacePtCoo = ut_realloc_2d_delline ((*pTess).FacePtCoo, (*pTess).FaceQty + 1, pos + 1);
  (*pTess).FaceFF = ut_realloc_1d ((*pTess).FaceFF, pos + 1);
  (*pTess).FaceDom = ut_realloc_2d_int_delline ((*pTess).FaceDom, (*pTess).FaceQty + 1, pos + 1);
...
neut_tess_compress_edges (struct TESS* pTess)
{
  ...
  // realloc'ing
  (*pTess).EdgeVerNb = ut_realloc_2d_int_delline ((*pTess).EdgeVerNb, (*pTess).EdgeQty + 1, pos + 1);
  (*pTess).EdgeFaceQty = ut_realloc_1d_int ((*pTess).EdgeFaceQty, pos + 1);
  (*pTess).EdgeFaceNb = ut_realloc_2d_int_delline ((*pTess).EdgeFaceNb, (*pTess).EdgeQty + 1, pos + 1);
  ...
  (*pTess).EdgeDom = ut_realloc_2d_int_delline ((*pTess).EdgeDom, (*pTess).EdgeQty + 1, pos + 1);
...
neut_tess_compress_vers (struct TESS* pTess)
{
  ...
  // realloc'ing
  (*pTess).VerCoo = ut_realloc_2d_delline ((*pTess).VerCoo, (*pTess).VerQty + 1, pos + 1);
  (*pTess).VerEdgeQty = ut_realloc_1d_int ((*pTess).VerEdgeQty, pos + 1);
  (*pTess).VerEdgeNb = ut_realloc_2d_int_delline ((*pTess).VerEdgeNb, (*pTess).VerQty + 1, pos + 1);
  (*pTess).VerDom = ut_realloc_2d_int_delline ((*pTess).VerDom, (*pTess).VerQty + 1, pos + 1);
