...
void
neut_tess_ver_poly_faces (struct TESS Tess, int ver, int poly, int** pface, int* pfaceqty)
{
  int i;
  ...
  (*pfaceqty) -= ut_array_1d_int_deletencompress (*pface, *pfaceqty, 0, *pfaceqty);
...
int
neut_tess_domfaces_comdomver (struct TESS Tess, int* face, int faceqty, int* pver)
{
  int i, status, qty;
  int* nb = NULL;
...
int
neut_tess_domfaces_comdomedge (struct TESS Tess, int* dface, int dfaceqty, int* pdedge)
{
  int i, status, qty;
  int* nb = NULL;
...
int
neut_tess_domvers_comdomedge (struct TESS Tess, int* dver, int dverqty, int* pdedge)
{
  int status, i, qty;
  int* id = NULL;
...
int
neut_tess_domedges_comdomver (struct TESS Tess, int* dedge, int dedgeqty, int* pdver)
{
  int status, i, qty;
  int* id = NULL;
...
int
neut_tess_domedges_comdomface (struct TESS Tess, int* dedge, int dedgeqty, int* pdface)
{
  int status, i, qty;
  int* id = NULL;
